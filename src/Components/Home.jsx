    ...
    <div className='w-full max-h-full'>
      ...
      <div className='home w-full px-20 pt-10 relative'>
        ...
        <div className="img flex items-center justify-center relative">
          ...
          <div className='container absolute top-[37vw] transform -translate-y-1/2 left-0 pl-20'>
            <div className='w-[45vw] border shadow-xl p-10 rounded-lg bg-white'>
              <button className='bg-[#4b6bfb] text-white p-2 border border-white rounded-lg'>Technology</button>
              <h1 className='text-[2.6vw] pt-4'>The Impact of Technology on the Workplace: How Technology is Changing</h1>
      ...
      {/* Advertisement */}
      <div className='pt-[7vw] flex items-center justify-center'>
