  ...
  return (
    <div className='w-full max-h-full'>
      ...
      <div className='px-20 pt-10'>
        <div className='px-[13vw] py-10 border border-none rounded-lg flex flex-col items-center justify-center gap-4 bg-[#f6f6f7]'>
            <div className='flex items-center justify-center gap-5'>
                <img className='w-14 rounded-full' src={Sajjad} alt="" />
                <div className='pt-5 leading-none'>
                    <h1 className='font-semibold'>Sajjad Ansari</h1>
                    <h1>Collaborator & Editor</h1>
                </div>
            </div>
            <p className='px-[13vw] text-center text-xl'>Meet Sajjad Ansari, a passionate writer and blogger with a love for technology and travel. Jonathan holds a degree in Computer Science and has spent years working in the tech industry, gaining a deep understanding of the impact technology has on our lives.</p>
            ...
            <div className='icon'>
                <div className='pt-10 flex items-center justify-center gap-10'>
                    ...
                    <a href=""><i class="fa-brands fa-twitter border border-none rounded-lg bg-[#696a75] p-4 text-white"></i></a>
                    <a href=""><i class="fa-brands fa-instagram border border-none rounded-lg bg-[#696a75] p-4 text-white"></i></a>
                    <a href=""><i class="fa-brands fa-youtube border border-none rounded-lg bg-[#696a75] p-4 text-white"></i></a>
                </div>
            </div>
        </div>
      ...
      <h1 className='text-[2vw]'>Latest Post</h1>
